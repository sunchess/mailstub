defmodule Mailstub.Auth.Controller do
  @moduledoc """
      ...
      def action(conn, _opts) do
        apply(
          ...
          [
            conn,
            conn.params,
            Mailstub.Auth.Guardian.Plug.current_resource(conn, key: unquote(key)),
            Mailstub.Auth.Guardian.Plug.current_claims(conn, key: unquote(key))
          ]
        )
      end
    end
